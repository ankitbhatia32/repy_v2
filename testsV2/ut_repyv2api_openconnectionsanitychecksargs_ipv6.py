...
try:
  ...
  openconnection_ipv6('foo.com', 1000, myip, 12345, 10)
...
try:
  ...
  openconnection_ipv6('0.1.2.3', 1000, myip, 12345, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('234.1.2.3', 1000, myip, 12345, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('1.2.3.4', 1000, '0.0.0.0', 12345, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('1.2.3.4', 0, myip, 12345, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('1.2.3.4', 65536, myip, 12345, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('1.2.3.4', 12345, myip, 5423452, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('1.2.3.4', 12345, myip, -5, 10)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  ...
  openconnection_ipv6('1.2.3.4', 12345, myip, 12345, -.0001)
except RepyArgumentError:
  # expected
  pass
else:
...
try:
  # incorrect arg type
  openconnection_ipv6('1.2.3.4', 12345, myip, 12345, None)
except RepyArgumentError:
  # expected
  pass
else:
